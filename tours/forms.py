...
from .models import Tour, Booking, Review, UAPDepartment, Wishlist, Notification
...
class NotificationForm(forms.ModelForm):
    class Meta:
        model = Notification
        fields = ('title', 'message', 'notification_type', 'tour', 'send_to_all_tourists')
        widgets = {
            'message': forms.Textarea(attrs={'rows': 4, 'placeholder': 'Enter your notification message...'}),
            'title': forms.TextInput(attrs={'placeholder': 'Enter notification title...'}),
        }
